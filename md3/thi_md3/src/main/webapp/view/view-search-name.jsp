    ...
    <div class="row bg-light">
        <div class="col-lg-12">
            ...
            <table class="table" border="1" cellpadding="5" style="display: inline-block; width: 100%; overflow-x: scroll; align-content: center" >
                ...
                <tbody>
                <tr>
                    <td><c:out value="${productNameList.getIdProduct()}"/></td>
                    <td><c:out value="${productNameList.getName()}"/></td>
                    <td><c:out value="${productNameList.getPrice()}"/></td>
                    <td><c:out value="${productNameList.getAmount()}"/></td>
                    <td><c:out value="${productNameList.getDescription()}"/></td>
                    <td><c:out value="${productNameList.getIdColor()}"/></td>
                    <td><c:out value="${productNameList.getIdCategory()}"/></td>
                        <%--  button edit--%>
                        <%--                    sua lai customer--%>
                    <!-- Button trigger modal -->
                    <td>
                        <button onclick="onDelete('${productNameList.getIdProduct()}','${productNameList.getName()}')" type="button"
